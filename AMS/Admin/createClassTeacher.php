...
if(isset($_POST['save'])){
  ...
  if($ret > 0){ 
      ...
      $query = mysqli_query($conn,"INSERT into tblclassteacher(firstName, lastName, emailAddress, password, phoneNo, classId, classArmId, dateCreated, verificationToken) 
      VALUES('$firstName', '$lastName', '$emailAddress', '$sampPass_2', '$phoneNo', '$classId', '$classArmId', '$dateCreated', '$token')");
      ...
      if ($query) {
          ...
          if ($qu) {
              ...
              sendVerificationEmail($emailAddress, $token);
              $statusMsg = "<div class='alert alert-success' style='margin-right:700px;'>Created Successfully! A verification email has been sent to the teacher.</div>";
          } else {
              $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>An error occurred while assigning class arm!</div>";
          }
      } else {
          $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>An error occurred during teacher creation!</div>";
      }
  }
}
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Instructor</h1>
            <ol class="breadcrumb">
