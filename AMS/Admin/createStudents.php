...
if(isset($_POST['save'])){
  ...
  // Email validation: Ensure the email ends with '@gmail.com'
  if (!preg_match("/^[a-zA-Z0-9._%+-]+@gmail\.com$/", $emailAddress)) {
      $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>Invalid Email Address! Please use a Gmail account.</div>";
  } else {
      ...
      if($ret > 0){ 
          ...
          $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,emailAddress,admissionNumber,password,classId,classArmId,dateCreated) 
          value('$firstName','$lastName','$emailAddress','$admissionNumber','$sampPass_2','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    emailAddress='$emailAddress', admissionNumber='$admissionNumber',password='$sampPass_2', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" name="emailAddress" value="<?php echo $row['emailAddress'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      ...
                      tblstudents.lastName,tblstudents.emailAddress,tblstudents.admissionNumber,tblstudents.dateCreated
                      FROM tblstudents
